 ...
 * @param askingName         The blog name of the user asking the question
 * @param askingUrl          The blog URL of the user asking the question
...
class AnswerPost(
    ...
    val askingName: Option[String],
    val askingUrl: Option[String],
