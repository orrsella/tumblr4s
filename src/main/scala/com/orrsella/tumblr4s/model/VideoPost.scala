 ...
 * @param permalinkUrl       The permanent link to the video
 * @param thumbnailUrl       A thumbnail url
 * @param thumbnailWidth     The thumbnail's width
 * @param thumbnailHeight    The thumbnail's height
 * @param htmlCapable        Indicates if the player is HTML5 capable (???)
 * @param player             The embeddable player
 */
class VideoPost(
    ...
    val permalinkUrl: Option[String],
    val thumbnailUrl: Option[String],
    val thumbnailWidth: Option[Int],
    val thumbnailHeight: Option[Int],
    val htmlCapable: Option[Boolean],
    val player: Option[Seq[VideoPlayer]])
  extends Post